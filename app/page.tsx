...
const roadSegments = [
  { id: 'RD-001', name: 'NH-48 Delhi–Gurgaon Expressway KM 5-12', health: 87, trend: 'up', status: 'good', temp: 42, vibration: 0.8, strain: 145, lastInspection: '2 days ago' },
  { id: 'RD-002', name: 'Mumbai–Pune Expressway — Lonavala Section', health: 64, trend: 'down', status: 'warning', temp: 38, vibration: 1.4, strain: 210, lastInspection: '5 days ago' },
  { id: 'RD-003', name: 'Bandra–Worli Sea Link — Deck Section A', health: 42, trend: 'down', status: 'critical', temp: 35, vibration: 2.1, strain: 285, lastInspection: '1 day ago' },
  { id: 'RD-004', name: 'Bangalore ORR — Electronic City Corridor', health: 93, trend: 'up', status: 'good', temp: 40, vibration: 0.5, strain: 120, lastInspection: '4 days ago' },
  { id: 'RD-005', name: 'NH-44 Hyderabad — Shamshabad Bypass', health: 71, trend: 'flat', status: 'warning', temp: 31, vibration: 1.1, strain: 190, lastInspection: '3 days ago' },
  { id: 'RD-006', name: 'Lucknow–Agra Expressway KM 80-95', health: 95, trend: 'up', status: 'good', temp: 39, vibration: 0.3, strain: 105, lastInspection: '1 day ago' },
];
